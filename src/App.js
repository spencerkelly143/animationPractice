...
class App extends React.Component {
  constructor(){
    ...
    let randomNums = []
    for (let i = 0; i<100; i++) {
      randomNums[i] = [Math.random()*(72-28)+28, Math.random()*(97-3)+3, Math.random()*(0.2-0.1)+0.1, Math.random()*(0.05-0.01)+0.01, i, Math.random()*(50-20)+20,Math.random()*(73-23)+23, Math.random()*(97-3)+3]
    }
    this.state = {
